(function() {
    // Set up Pixi.js
    let renderer = PIXI.autoDetectRenderer(660, 660, {backgroundColor: 0x34495e, antialias: true});
    ...
    let boxWidth = renderer.width / 10;
    let boxHeight = renderer.height / 10;
