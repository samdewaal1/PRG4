...
function collisionResponse(object1, object2) {
    ...
    const vRelativeVelocity = new PIXI.Point(object1.acceleration.x - object2.acceleration.x, object1.acceleration.y - object2.acceleration.y);
...
app.ticker.add((delta)=>{
    ...
    if (greenSquare.x < 0 || greenSquare.x > app.screen.width - 100) greenSquare.acceleration.x = -greenSquare.acceleration.x;
    if (greenSquare.y < 0 || greenSquare.y > app.screen.height - 100) greenSquare.acceleration.y = -greenSquare.acceleration.y;
    // If the green square pops out of the cordon, it pops back into the
    // middle
    if (greenSquare.x < -30 || greenSquare.x > app.screen.width + 30 || greenSquare.y < -30 || greenSquare.y > app.screen.height + 30) greenSquare.position.set((app.screen.width - 100) / 2, (app.screen.height - 100) / 2);
    // If the mouse is off screen, then don't update any further
    if (app.screen.width > mouseCoords.x || mouseCoords.x > 0 || app.screen.height > mouseCoords.y || mouseCoords.y > 0) {
        // Get the red square's center point
        const redSquareCenterPosition = new PIXI.Point(redSquare.x + redSquare.width * 0.5, redSquare.y + redSquare.height * 0.5);
        // Calculate the direction vector between the mouse pointer and
        // the red square
        const toMouseDirection = new PIXI.Point(mouseCoords.x - redSquareCenterPosition.x, mouseCoords.y - redSquareCenterPosition.y);
...
},{}]},["8Of3k","igcvL"], "igcvL", "parcelRequire8574")
